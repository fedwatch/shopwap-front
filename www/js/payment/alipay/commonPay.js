define(function (require, exports, module) {
    ...
    $(function () {
        ...
        $(document).on('click', '.modal-inner .bank-li a', function () {
            ...
            console.log(cardId);
            var app_request_url = location.protocol+"//"+location.host + '/www/html';
            ...
            success: function (data) {
                if (data.authStatus == "200") {
                    ...
                    require.async("handlebars", function () {
                        var tpl = require('/zqVue/shopwap-front/www/layout/payment/alipay/commonPay.tpl');
                ...
                if (data.authStatus == '200') {
                    require.async("handlebars", function () {
                        require.async("transCommonPay", function () {
                            var tpl = require('/zqVue/shopwap-front/www/layout/payment/bankList.tpl');
                            var template = Handlebars.compile(tpl);
                            var html = template(data);
                            $("#bankList").html(html);
                        });
