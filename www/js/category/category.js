...
define(function (require, exports, module) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    require.async('handlebars', function () {
                        var getData = data;
                        var tpl = require('/zqVue/shopwap-front/www/layout/cartgory/navSubPosition.tpl');
    ...
    function getProductDetail(id) {
        ...
        location.href = '/www/html/detail/detail.html';
    }
    ...
    require.async('handlebars', function () {
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.authStatus == "200") {
                    var tpl = require('/zqVue/shopwap-front/www/layout/cartgory/mainNav.tpl');
                    var template = Handlebars.compile(tpl);
                    var html = template(data);
                    $("#mainNav").html(html);
