...
define(function (require, exports, module) {
    ...
    require.async('handlebars', function () {
        var data = genData;
        var tpl = require('/zqVue/shopwap-front/www/layout/search/searchHeader.tpl');
    ...
    require.async('handlebars', function () {
        var data = genData;
        var tpl = require('/zqVue/shopwap-front/www/layout/search/searchVague.tpl');
        var template = Handlebars.compile(tpl);
        var html = template(data);
    ...
    require.async('handlebars', function () {
        ...
        if (historySearch == '') {
            ...
            var tpl = require('/zqVue/shopwap-front/www/layout/search/historySearch.tpl');
            var template = Handlebars.compile(tpl);
            var html = template(data);
    ...
    function search(keyword, pageNumber, pageSize) {
        $.ajax({
            ...
            success: function (data) {
               ...
               /* require.async('handlebars', function () {
                    var tpl = require('/www/layout/cartgory/productCategory.tpl');
                    var template = Handlebars.compile(tpl);
                    MAK = template(data);
                    console.log(MAK);
                });
