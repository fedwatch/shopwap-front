...
define(function (require, exports, module) {
    ...
    $(document).on("click", "#checkoutBtn", function () {
        if (userStatus) {
            ...
            if (cartItemIdArray.length !== 0) {
                location.href = "/www/html/order/order.html";
            } else {
                $.toast("购物车没有选中商品！")
            }
        } else {
    ...
    require.async('handlebars', function () {
        ...
        var tpl = require('/zqVue/shopwap-front/www/layout/cart/cart.tpl');
        var template = Handlebars.compile(tpl);
    ...
    require.async('handlebars', function () {
        ...
        var tpl = require('/zqVue/shopwap-front/www/layout/cart/cartHeader.tpl');
        var template = Handlebars.compile(tpl);
        var html = template(storeData);
    ...
    require.async('handlebars', function () {
        var storeData = {};
        var tpl = require('/zqVue/shopwap-front/www/layout/cart/cartFooter.tpl');
        var template = Handlebars.compile(tpl);
        var html = template(storeData);
    ...
    require.async('handlebars', function () {
        var storeData = {};
        var tpl = require('/zqVue/shopwap-front/www/layout/cart/nothingBuy.tpl');
        var template = Handlebars.compile(tpl);
        var html = template(storeData);
