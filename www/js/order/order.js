            ...
            success: function (data) {
                if (data.authStatus == "200") {
                    ...
                    if (data.mergeSn) {
                        ...
                        return window.location.href = "/www/html/payment/alipay/commonPay.html";
            ...
            success: function (data) {
                if (data.authStatus == "200") {
                    ...
                    require.async('handlebars', function () {
                        var tpl = require('/zqVue/shopwap-front/www/layout/order/orderHeader.tpl');
                    ...
                    //orderAddress
                    require.async('handlebars', function () {
                        var tpl = require('/zqVue/shopwap-front/www/layout/order/orderAddress.tpl');
                        var template = Handlebars.compile(tpl);
                        var html = template(data);
                    ...
                    //orderDetail
                    require.async('handlebars', function () {
                        var tpl = require('/zqVue/shopwap-front/www/layout/order/orderDetail.tpl');
                        var template = Handlebars.compile(tpl);
                        var html = template(data);
                    ...
                    //orderBottomBar
                    require.async('handlebars', function () {
                        var tpl = require('/zqVue/shopwap-front/www/layout/order/orderBottomBar.tpl');
                        var template = Handlebars.compile(tpl);
                        var html = template(data);
