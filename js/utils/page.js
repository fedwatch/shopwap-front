...
function initPage(DOM,listCount,currentPage,fun){
    var maxshowpageitem = $(DOM).attr("maxshowpageitem");
    if(maxshowpageitem!=null&&maxshowpageitem>0&&maxshowpageitem!=""){
        page.maxshowpageitem = maxshowpageitem;
    }
    var pagelistcount = $(DOM).attr("pagelistcount");
    if(pagelistcount!=null&&pagelistcount>0&&pagelistcount!=""){
        page.pagelistcount = pagelistcount;
    }

    var pageId = $(DOM).attr("id");
    page.pageId=pageId;
    if(listCount<0){
        listCount = 0;
    }
