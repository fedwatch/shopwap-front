        ...
        <div class="cart-item">
            ...
            <div class="cart-store-img-text-label">
                ...
                <div class="cart-item-text">
                    <div class="row">
                        <div class="col-66">
                            <h2 class="cart-item-buying-title">韩国火烈鸟iphone7 plus手机壳苹果6s plus硅胶保护套全包防摔壳</h2>
                            <span class="cart-item-buying-desc">颜色分类：一二三四五六七八九十一二三四五六七八九十</span>
                        </div>
        ...
        <div class="cart-item">
            ...
            <div class="cart-store-img-text-label">
                ...
                <div class="cart-item-text">
                    <div class="row">
                        <div class="col-66">
                            <h2 class="cart-item-buying-title">新款韩版时尚潮流钢带情侣日历皮带男女士手表 学生防水石英腕表</h2>
                            <span class="cart-item-buying-desc">颜色分类：一二三四五六七八九十一二三四五六七八九十</span>
                        </div>
        ...
        <div class="cart-item">
            ...
            <div class="cart-store-img-text-label">
                ...
                <div class="cart-item-text">
                    <div class="row">
                        <div class="col-66">
                            <h2 class="cart-item-buying-title">天然正品琥珀蜜蜡花珀吊坠血泊项链女款附证书</h2>
