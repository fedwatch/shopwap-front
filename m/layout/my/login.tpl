...
<div class="content">
    ...
    <div class="content-block" style="padding:0 2rem;">
        <a id="loginBtn" class="button button-big  external "
           style="background: linear-gradient(0,#ee4e15,#ff6a10);color:#fff;border:0;border-radius: 5rem;background: -moz-linear-gradient(bottom,#ee4e15,#ff6a10);-moz-border-radius: 5rem;display:block;" href="javascript:void(0)"
           data-transition="fade">
            登录
        </a>
        <p class="text-center signup">
            <a href="/m/html/my/register/register.html" class="external" style="color:#fff;">立即注册</a>
            <span style="color:#fff;">|</span>
            <a href="/m/html/my/forgetPassword/forgetPassword.html" class="external" style="color:#fff;">忘记密码</a>
        </p>
    </div>
</div>
